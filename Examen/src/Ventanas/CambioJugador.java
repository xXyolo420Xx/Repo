...
public class CambioJugador extends JPanel {
	...
	public CambioJugador(Juego jueg, VentanaPostLogin v2) {
		
		comboBox = new JComboBox();
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//METEMOS LOS DATOS DEL JUGADOR SELECCIONADO EN EL JCOMBOBOX
				setJ1((Jugador)comboBox.getSelectedItem());
			}
		});
		...
		JButton btnAct = new JButton("Jugar");
		btnAct.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				txtRes.setText("Cambio de jugador con éxito");
				
				//COJEMOS EL CARDLAYOUT Y PONEMOS LA VENTANA JUEGO YA CON EL NUEVO JUGADOR
				((CardLayout) v2.getLayout()).show(v2.contentPane, JUEGO);
		...
		//METODO PARA AÑADIR LOS ELEMENTOS AL COMBOBOX
	...
	this.j1 = j1;
	txtNombre.setText(j1.getNombre());
	txt1Apellido.setText(j1.getApellido1());
	txt2Apellido.setText(j1.getApellido2());
	txtEdad.setText(String.valueOf(j1.getEdad()));
	txtPuntos.setText(String.valueOf(j1.getPuntos()));
	}

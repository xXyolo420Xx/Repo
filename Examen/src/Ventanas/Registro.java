...
public class Registro extends JFrame {
	...
	private JLabel lblDatosNuevoador;
	...
	public Registro(VentanaPostLogin v2) {
		...
		lblDatosNuevoador = new JLabel("DATOS NUEVO ADOR");
		lblDatosNuevoador.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblDatosNuevoador.setBounds(121, 11, 192, 14);
		contentPane.add(lblDatosNuevoador);
		...
		btnCrear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//HACEMOS ESTO EN VEZ DE UTILIZAR LOS GETTERS DE LA CLASE ADOR PORQUE LOS INTEGERS (EDAD) NO TIENEN LONGITUD
				...
				//AGREGAMOS EL NUEVO ADOR A LA BBDD
				Jugador j1 = ConexionDDBB.insertar(txtNombre.getText(), txt1Apellido.getText(), txt2Apellido.getText(), Integer.valueOf(txtEdad.getText()));
				v2.setJ1(j1);
				v2.camb.comboBox.addItem(j1);
